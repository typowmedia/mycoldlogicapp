...
const BonusRecognitions = ({ classes, mobile }) => (
        ...
        return (
          <div className={classes.mobileBonusContainer}>
            {bonuses.map(bonus => {
              ...
              const dlyIncTot = (
                Math.round(bonus.dlyIncTot * 100) / 100
              ).toFixed(2);
              const wklyIncTot = (
                Math.round(bonus.wklyIncTot * 100) / 100
              ).toFixed(2);
              const grssInc = (Math.round(bonus.grssInc * 100) / 100).toFixed(
                2,
              );
