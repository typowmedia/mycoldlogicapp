...
const FeedbackNeutralSad = (props) => {
    return <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
        <title>NeutralSadIcon</title>
        <path
	...
	c-3.5-5.7-9.7-9.6-16.9-9.6S36.5,71.9,33.1,77.7z" fill={props.color}/>
    </svg>
};

export default FeedbackNeutralSad